...
class UserCreateDtoTest extends TestCase
{
    ...
    {
        $dto = new UserCreateDto('John', 'john@example.com', '', 'manager', false);
    ...
    {
        $dto = new UserCreateDto('John', 'john@example.com', '', 'manager');
    ...
    {
        $dto = new UserCreateDto('John', 'john@example.com', '', 'manager', true);
    ...
    {
        $dto = new UserCreateDto('John', 'john@example.com', '', 'admin');
